"""
STEP 5: Feature Selection trên 81 features (gốc + technicals shifted) rồi train lại
...
def main():
    ...
    rank.to_csv(os.path.join(OUT_DIR, 'step5_feature_ranking.csv'), index=False)
    ...
    print(f'\n{rdf.to_string()}')
    rdf.to_csv(os.path.join(OUT_DIR, 'step5_results.csv'), index=False)
